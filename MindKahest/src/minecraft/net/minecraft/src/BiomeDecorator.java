...
public class BiomeDecorator
{
    ...
    ///////////NEW//////////
    protected WorldGenerator EtainGen;
    protected WorldGenerator CuivreGen;
    protected WorldGenerator LaitonGen;
    protected WorldGenerator MithrilGen;
    protected WorldGenerator pierredesangGen;
    //////////FIN NEW//////
    ...
    {
    	/////////////NEW///////////
        EtainGen = new WorldGenMinable(Block.OreEtain.blockID, 8);
        CuivreGen = new WorldGenMinable(Block.OreCuivre.blockID, 8);
        LaitonGen = new WorldGenMinable(Block.OreLaiton.blockID, 8);
        MithrilGen = new WorldGenMinable(Block.OreMithril.blockID, 8);
        pierredesangGen = new WorldGenMinable(Block.Orepierredesang.blockID, 7);
        /////////////FIN///////////
    ...
    {
   	    ////// NEW //////
    	genStandardOre1(20, EtainGen, 0, 64);
    	genStandardOre1(20, CuivreGen, 0, 64);
    	genStandardOre1(20, LaitonGen, 0, 64);
    	genStandardOre1(1, pierredesangGen, 0, 46);
    	genStandardOre1(2, MithrilGen, 0, 55);
    	///// FIN ////
        ...
        genStandardOre1(2, goldGen, 0, 55);
        genStandardOre1(8, redstoneGen, 0, 46);
        genStandardOre1(1, diamondGen, 0, 46);
        genStandardOre2(1, lapisGen, 16, 46);
    }
}
