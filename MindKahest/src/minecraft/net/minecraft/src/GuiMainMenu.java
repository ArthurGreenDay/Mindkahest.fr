...
public class GuiMainMenu extends GuiScreen
{
    ...
    private GuiButton mindkahestButton;
    /** The splash message. */
    ...
    public void initGui()
    {
        ...
        else if (calendar.get(2) + 1 == 4 && calendar.get(5) == 23)
        {
            splashText = "Ouverture Officiel du Serveur!";
        }
        else if (calendar.get(2) + 1 == 2 && calendar.get(5) == 14)
        {
            splashText = "Joyeuse Saint valentin !";
        }
        ...
        controlList.add(mindkahestButton = new GuiButton(5, width / 2 - 0, i + 12 + 12, 98, 20, stringtranslate.translateKey("Mindkahest.fr")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if(par1GuiButton.id == 5)
        {
            mc.displayGuiScreen(new GuiConnecting(mc, "94.23.238.47", 25906));
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, "Mindkahest 1.0", 2, height - 10, 0xffffff);
        String s = "";
