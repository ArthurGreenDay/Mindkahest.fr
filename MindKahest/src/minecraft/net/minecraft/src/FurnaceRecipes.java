...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        addSmelting(Block.OreLaiton.blockID, new ItemStack(Item.Laiton_INGOT));
        addSmelting(Block.OreCuivre.blockID, new ItemStack(Item.Cuivre_INGOT));
        addSmelting(Block.OreEtain.blockID, new ItemStack(Item.Etain_INGOT));
        addSmelting(Block.OreMithril.blockID, new ItemStack(Item.Mithril_INGOT));
