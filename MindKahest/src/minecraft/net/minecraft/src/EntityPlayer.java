...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        playerCloakUrl = (new StringBuilder()).append("http://www.mindkahest.fr/launcher/Cape/").append(username).append(".png").toString();
        cloakUrl = playerCloakUrl;
    }
    public void updateHat()
    {
        playerHatUrl = (new StringBuilder()).append("http://www.mindkahest.fr/launcher/Hat/").append(username).append(".png").toString();
        hatUrl = playerHatUrl;
    }
    /**
