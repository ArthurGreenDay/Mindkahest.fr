...
public class Item
{
    ...
    //*NEW ITEM
    //
    public static Item hoePierredesang;
    public static Item swordPierredesang;
    public static Item shovelPierredesang;
    public static Item pickaxePierredesang;
    public static Item axePierredesang;
    //
    ...
    //
    public static Item hoeLaiton;
    public static Item swordLaiton;
    public static Item shovelLaiton;
    public static Item pickaxeLaiton;
    public static Item axeLaiton;
    //
    public static Item hoeEtain;
    public static Item swordEtain;
    public static Item shovelEtain;
    public static Item pickaxeEtain;
    public static Item axeEtain;
    //
    public static Item hoeCuivre;
    public static Item swordCuivre;
    public static Item shovelCuivre;
    public static Item pickaxeCuivre;
    public static Item axeCuivre;
    public static Item Etain_INGOT = (new Item(138)).setIconCoord(6, 5).setItemName("Etain");
	public static Item Laiton_INGOT = (new Item(139)).setIconCoord(6, 7).setItemName("Laiton");
    public static Item Mithril_INGOT = (new Item(140)).setIconCoord(6, 8).setItemName("Mithril");
    public static Item Cuivre_INGOT = (new Item(141)).setIconCoord(6, 6).setItemName("cuivre");
    public static Item pierredesang_INGOT = (new Item(142)).setIconCoord(6, 9).setItemName("pierredesang");
    //
    /**
    ...
    static
    {
        ...
        //
         swordEtain = (new ItemSword(144, EnumToolMaterial.Etain)).setIconCoord(0, 9).setItemName("swordEtain");
         shovelEtain  = (new ItemSpade(145, EnumToolMaterial.Etain)).setIconCoord(0, 13).setItemName("shovelEtain");
         pickaxeEtain = (new ItemPickaxe(146, EnumToolMaterial.Etain)).setIconCoord(0, 11).setItemName("pickaxeEtain");
         axeEtain = (new ItemAxe(147, EnumToolMaterial.Etain)).setIconCoord(0, 12).setItemName("axeEtain");
         hoeEtain = (new ItemHoe(148, EnumToolMaterial.Etain)).setIconCoord(0, 13).setItemName("hoeEtain");
        //
         swordLaiton = (new ItemSword(149, EnumToolMaterial.Laiton)).setIconCoord(2, 9).setItemName("swordLaiton");
         shovelLaiton  = (new ItemSpade(150, EnumToolMaterial.Laiton)).setIconCoord(2, 10).setItemName("shovelLaiton");
         pickaxeLaiton = (new ItemPickaxe(151, EnumToolMaterial.Laiton)).setIconCoord(2, 11).setItemName("pickaxeLaitone");
         axeLaiton = (new ItemAxe(152, EnumToolMaterial.Laiton)).setIconCoord(2, 12).setItemName("axeLaiton");
         hoeLaiton = (new ItemHoe(153, EnumToolMaterial.Laiton)).setIconCoord(2, 13).setItemName("hoeLaiton");
        //
         swordCuivre = (new ItemSword(154, EnumToolMaterial.Cuivre)).setIconCoord(1, 9).setItemName("swordCuivre");
         shovelCuivre  = (new ItemSpade(155, EnumToolMaterial.Cuivre)).setIconCoord(1, 10).setItemName("shovelCuivre");
         pickaxeCuivre = (new ItemPickaxe(156, EnumToolMaterial.Cuivre)).setIconCoord(1, 11).setItemName("pickaxeCuivre");
         axeCuivre = (new ItemAxe(157, EnumToolMaterial.Cuivre)).setIconCoord(1, 12).setItemName("axeCuivre");
         hoeCuivre = (new ItemHoe(158, EnumToolMaterial.Cuivre)).setIconCoord(1, 13).setItemName("hoeCuivre");
        //
         swordMithril = (new ItemSword(159, EnumToolMaterial.Mithril)).setIconCoord(3, 9).setItemName("swordMithril");
         shovelMithril  = (new ItemSpade(160, EnumToolMaterial.Mithril)).setIconCoord(3, 10).setItemName("shovelMithril");
         pickaxeMithril = (new ItemPickaxe(161, EnumToolMaterial.Mithril)).setIconCoord(3, 11).setItemName("pickaxeMithril");
         axeMithril = (new ItemAxe(162, EnumToolMaterial.Mithril)).setIconCoord(3, 12).setItemName("axeMithril");
         hoeMithril = (new ItemHoe(163, EnumToolMaterial.Mithril)).setIconCoord(3, 13).setItemName("hoeMithril");
        //
         swordPierredesang = (new ItemSword(164, EnumToolMaterial.Pierredesang)).setIconCoord(4, 9).setItemName("swordPierredesang");
         shovelPierredesang  = (new ItemSpade(165, EnumToolMaterial.Pierredesang)).setIconCoord(4, 10).setItemName("shovelPierredesang");
         pickaxePierredesang = (new ItemPickaxe(166, EnumToolMaterial.Pierredesang)).setIconCoord(4, 11).setItemName("pickaxePierredesang");
         axePierredesang = (new ItemAxe(167, EnumToolMaterial.Pierredesang)).setIconCoord(4, 12).setItemName("axePierredesang");
         hoePierredesang = (new ItemHoe(168, EnumToolMaterial.Pierredesang)).setIconCoord(4, 13).setItemName("hoePierredesang");
        // FIN NEW ITEM
        StatList.initStats();
    }
}
