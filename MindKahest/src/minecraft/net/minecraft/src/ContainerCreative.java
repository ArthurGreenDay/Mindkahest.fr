...
class ContainerCreative extends Container
{
    ...
    public ContainerCreative(EntityPlayer par1EntityPlayer)
    {
        ...
        Block ablock[] =
        {
            ...
            Block.trapdoor, Block.enchantmentTable, Block.redstoneLampIdle, Block.orangeGlass, Block.blancGlass, Block.rougeGlass, Block.noirGlass, Block.vertGlass, Block.marronGlass, Block.bleuGlass, Block.violetGlass, Block.grisGlass, Block.roseGlass,
            Block.vertclairGlass, Block.jauneGlass, Block.bleuclairGlass, Block.violetclairGlass, Block.TapisBlanc, Block.TapisNoir, Block.TapisGrisFonce, Block.TapisRouge, Block.TapisRose, Block.TapisVert, Block.TapisVertClair, Block.TapisMarron, Block.TapisJaune,
            Block.TapisBleu, Block.TapisBleuClair, Block.TapisViolet, Block.TapisMagenta, Block.TapisCyan, Block.TapisOrange, Block.TapisGrisClair, Block.stairsSandStone, Block.stairsObsidian, Block.OreLaiton, Block.OreCuivre, Block.OreEtain, Block.OreMithril, Block.Orepierredesang,
            Block.stairsMossystonebrick, Block.speed, Block.jump, Block.superlampe
