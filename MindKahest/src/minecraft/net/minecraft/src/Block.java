...
public class Block
{
    ...
    ///////////////NEW//////////////
    public static final Block OreEtain;
    public static final Block OreLaiton;
    public static final Block OreMithril;
    public static final Block OreCuivre;
    public static final Block Orepierredesang;
    public static final Block stairsSandStone;
    public static final Block stairsMossystonebrick;
    public static final Block stairsObsidian;
    public static final Block test;
    public static final Block orangeGlass;
    public static final Block blancGlass;
    public static final Block rougeGlass;
    public static final Block noirGlass;
    public static final Block vertGlass;
    public static final Block marronGlass;
    public static final Block bleuGlass;
    public static final Block violetGlass;
    public static final Block grisGlass;
    public static final Block roseGlass;
    public static final Block vertclairGlass; 
    public static final Block jauneGlass;
    public static final Block bleuclairGlass;
    public static final Block violetclairGlass;
    ...
    public static final Block speed;
    public static final Block jump;
    public static final Block superlampe;
    ////////////////FIN NEW/////////////
    ...
    static
    {
        ...
        redstoneLampActive = (new BlockRedstoneLight(124, true)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight");
        					/////////////NEW /////////////////
        OreEtain = (new BlockOre(128, 200)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("OreEtain");
        OreCuivre = (new BlockOre(129, 201)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("OreCuivre");
        OreLaiton = (new BlockOre(130, 202)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("OreLaiton");
        OreMithril = (new BlockOre(131, 203)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("OreMithril");
        Orepierredesang = (new BlockOre(132, 204)).setHardness(6F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("Orepierredesang");
        stairsSandStone = (new BlockStairs(133, sandStone)).setBlockName("stairsSandStone").setRequiresSelfNotify();
        stairsObsidian = (new BlockStairs(134, obsidian)).setBlockName("stairsObsidian").setRequiresSelfNotify();
        test = (new BlockOre(136, 100));
        stairsMossystonebrick = (new BlockStairs(135, test)).setBlockName("Mossystonebrick").setRequiresSelfNotify();
        orangeGlass = (new BlockVitreColo(200, 168, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        blancGlass = (new BlockVitreColo(201, 169, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        rougeGlass = (new BlockVitreColo(202, 170, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        noirGlass = (new BlockVitreColo(203, 171, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        vertGlass = (new BlockVitreColo(204, 172, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        marronGlass = (new BlockVitreColo(205, 173, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        bleuGlass = (new BlockVitreColo(206, 184, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        violetGlass = (new BlockVitreColo(207, 185, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        grisGlass = (new BlockVitreColo(208, 186, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        roseGlass = (new BlockVitreColo(209, 187, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        vertclairGlass = (new BlockVitreColo(210, 188, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        jauneGlass = (new BlockVitreColo(211, 189, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        bleuclairGlass = (new BlockVitreColo(212, 190, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        violetclairGlass = (new BlockVitreColo(213, 191, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("vitrecolore");
        ...
        speed = (new BlockSpeed(156, 215)).setHardness(3.0F).setStepSound(soundWoodFootstep).setBlockName("Speed");
        jump = (new BlockSauteur(157, 216)).setHardness(3.0F).setStepSound(soundWoodFootstep).setBlockName("jump"); 
        superlampe = (new BlockGlowStone(158, 105, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(3.0F).setBlockName("lightgem");
        ///////////// FIN /////////////////
